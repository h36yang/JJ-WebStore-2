...
export const FEATURED_PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        desc: '困鹿山普洱茶香型独特, 在云南三大茶区中独有此茶能称得一个"雅"字。茶香清雅、高锐、持久, 韵长, 是"普洱茶"中的一秀, 历来是贡茶的首选。新茶入口微苦化甘转甜, 口感香、甘、甜相混而生, 丰富沉厚, 喉韵甘润持久, 气蕴上扬而沉实, 无愧皇家茶园称号而问鼎普洱茶界。',
        functions: [
            {
                summary: '降脂、提神、降压、减肥',
            ...
            },
            {
                ...
                detail: '饮茶可以降低人体血液中有害胆固醇的含量、而增加有益胆固醇含量、有降低血压的功效。同时可以降低血液的粘度、抗血小板凝集, 因此对预防心血管疾病(如脑血栓、冠心病等)有效。如据在荷兰进行的流行病学调查结果, 饮茶多的人群患冠心病的危险性可降低45%。'
            },
            {
                summary: '防辐射',
            ...
            {
                summary: '提高免疫性',
                detail: '人体的免疫性反映了对疾病的抵抗力。人体的免疫性可分为血液免疫和肠道免疫。饮茶可以增加血液中白血球和淋巴细胞的数量、提高血液免疫性。在美国报告茶叶中的茶氧酸在人体中可以使血液免疫细胞对外界侵袭产生抵御反应。除了血液免疫外, 饮茶还可以增加肠道中的有益细菌(如双歧杆菌)数量, 减少有害细菌的数量, 从而提高肠道免疫。'
            },
            {
                summary: '杀菌、抗病毒',
                detail: '饮茶对杀灭肠道疾病菌有持久的效果。在俄罗斯提倡腹泻病人饮浓茶汁进行治疗。日本和美国科学家证明茶叶中的EGCG对流感病毒有强的抑制作用, 阻止病毒粘附在细胞上。在前几年流行的"非典"时期, 世界卫生组织(WHO)和我国台湾省的专家建议喝茶可以阻止冠状病毒的入侵。'
            }
        ]
    }
];
...
export const HOT_PRODUCTS: Product[] = [
    {
        ...
        desc: '7581是普洱茶历史上第一款由人工渥堆发酵而成的普洱熟茶, 为云南中茶赢得了"熟茶发酵工艺首创者"的美誉。它不仅"主宰了整个80年代到90年代的熟砖系统", 而且到现在, 也是很多普洱茶茶友品茗的首选。2015年云南中茶公司为适应市场需求, 臻选原料精心拼配首度研发7581袋泡熟茶, 该茶汤色红亮, 醇厚润糯, 经久耐泡, 香纯甘甜, 外观精美, 简洁方便。',
        functions: [
            {
                summary: '安神',
                detail: '普洱熟茶是可以在睡前喝的安神茶, 而且无论年龄大小都可以睡前饮用。'
    ...
    },
    {
        ...
        origin: '中国 - 云南省 - 昆明市',
        producer: '云南中茶茶业有限公司',
        desc: '该茶臻选云南西双版纳勐海境内高海拔云南大叶种茶菁, 适度发酵, 采用创新工艺压制, 饼形圆润规整, 精致小巧, 饼面条索紧实, 红褐显毫。甜香显露, 汤色红浓, 滋味尚浓厚回味甜醇。每饼8克的小饼采用独立包装, 品饮便捷, 10小饼每盒的纸盒包装精致环保, 高端雅致。是您商务、休闲、旅行、工作的尚佳伴侣, 与您共享美好时光。',
        ...
        functions: [
            ...
            },
            {
                ...
                detail: '白茶片富含的二氢杨梅素等黄酮类天然物质可以保护肝脏, 加速乙醇代谢产物乙醛迅速分解, 变成无毒物质, 降低对肝细胞的损害。' +
                    '另一方面, 二氢杨梅素能够改善肝细胞损伤引起的血清乳酸脱氢酶活力增加, 抑制肝性M细胞胶原纤维的形成, 从而起到保肝护肝的作用, 大幅度降低乙醇对肝脏的损伤, 使肝脏正常状态迅速得到恢复。同时, 二氢杨梅素起效迅速, 并且作用持久, 是保肝护肝, 解酒醒酒的良品。'
            },
            {
                summary: '明目',
                detail: '白茶存放时间越长, 其药用价值更高。白茶中还含有丰富的维生素A原, 它被人体吸收后, 能迅速转化为维生素A, 维生素A能合成视紫红质, 能使眼睛在暗光下看东西更清楚, 可预防夜盲症与干眼病。同时白茶还有防辐射物质, 对人体的造血机能有显著的保护作用, 能减少电视辐射的危害。'
            },
            {
                summary: '抗癌症',
                detail: '在我们日常烹饪过程中, 糖、氨基酸等物质很容易转变成具有致癌作用的杂环胺类化合物, 研究结果表明白茶对多种杂环胺类致癌诱变剂的抑制效果非常显著。舒林酸与白茶结合使用还影响β-连环蛋白(β-catenin)的表达, 阻断致癌物质的形成, 从而对癌症起到化学预防的作用。并降低非甾体抗癌药物(NSAIDs)毒副作用等效果。'
            },
            {
                summary: '降血糖血脂、减肥',
                detail: '白茶特殊的加工工艺较好地保留了人体所必需而其它茶类含量较少的活性酶, 长期饮用白茶可以显著提高人体内脂蛋白脂肪酶活性, 促进脂肪分解代谢, 有效控制胰岛素分泌量, 延缓葡萄糖的吸收, 分解体内多余的糖分, 促进血糖平衡。同时促进胰液分泌, 使血糖来路减少, 去路增加。'
            }
        ]
    },
    {
        ...
        origin: '中国 - 广西梧州市',
        producer: '梧州中茶茶业有限公司',
        desc: '宝莉花茶是精选陈年六堡茶, 和新鲜的茉莉鲜花, 采用科学的窨制工艺加工而成, 兼具六堡茶"红浓陈醇"和茉莉花香特点。该茶外形紧结显毫, 香气浓郁鲜灵, 茶汤晶莹剔透似琥珀色, 口感醇滑, 齿颊留香, 叶底匀嫩红亮, 经久耐泡。适合不宜饮用绿茶、清香铁观音、普洱生茶之类人群, 是常坐在电脑前白领阶层人士首选饮品, 特别适合爱美的女士们饮用。',
        highlight: '茶性温和, 帮助消化, 健胃养神, 美容养颜',
        functions: [
            {
                summary: '膳食营养',
                detail: '黑茶中含有较丰富的营养成份, 最主要的是维生素和矿物质, 另外还有蛋白质、氨基酸、糖类物质等。 对主食牛、羊肉和奶酪, 饮食中缺少蔬菜和水果的西北地区的居民而言, 长期饮用湖南黑茶, 是他们人体必需矿物质和各种维生素的重要来源, 有生命之茶之说。'
            },
            {
                summary: '助消化解油',
                detail: '黑茶中的咖啡碱、维生素、氨基酸、磷脂等有助于人体消化, 调节脂肪代谢, 咖啡碱的刺激作用更能提高胃液的分泌量, 从而增进食欲, 帮助消化。日本学者通过科学检验已证明, 黑茶具有很强的解油腻、消食等功能, 这也是肉食民族特别喜欢这种茶的原因。' +
                    '中国西北少数民族人民的食物结构是牛、羊肉和奶酪, 故有"宁可三日无食, 不可一日无茶"之说, 这与茶叶能"去肥腻"、"解荤腥"的功效有很大关系。另外, 黑茶还能改善肠道微生物环境, 具有顺肠胃的功能。中国民间有利用老黑茶治疗腹胀、痢疾、不消食的传统。'
            },
            {
                summary: '降脂减肥',
                detail: '血脂含量高, 会使得脂质在血管壁上沉积, 因而引起动脉粥状硬化和形成血栓。黑茶具有良好的降解脂肪、抗血凝、促纤维蛋白原溶解作用和显著抑制血小板聚集, 还能使血管壁松弛, 增加血管有效直径, 从而抑制主动脉及冠状动脉内壁粥样硬化斑块的形成, 达到降压、软化血管, 防治心血管疾病的目的。' +
            ...
            {
                summary: '抗氧化',
                detail: '有关衰老的自由基理论认为, 在正常生理条件下, 人体内的自由基不断产生, 也不断被清除, 处于平衡状态。黑茶中不仅含有丰富的抗氧化物质如儿茶素类、茶色素、黄酮类、维生素C、维生素E、D一胡萝卜素等, 而且含有大量的具抗氧化作用的微量元素如锌、锰、铜(SOD的构成元素)和硒(GSHPX的构成元素)等。' +
                    '黑茶中的儿茶素、茶黄素、茶氨酸和茶多糖, 尤其是含量较多的复杂类黄酮等都具有清除自由基的功能, 因而具有抗氧化、延缓细胞衰老的作用。'
            },
            {
                summary: '抗癌',
                detail: '癌症是当前世界上引起人类死亡率极高的疾病之一。自20世纪70年代后期, 世界各国的科学家先后发现茶叶或茶叶提取物对多种癌症的发生具有抑制作用。湖南农业大学采用现代药物筛选的尖端技术高通量筛选技术对黑茶进行肿瘤细胞模型SGC7901的高通量筛选研究, 证明黑茶对肿瘤细胞具有明显的抑制作用。'
            },
            {
                summary: '降血压',
            ...
            },
            {
                ...
                detail: '黑茶中的茶多糖复合物是降血糖的主要成分。茶多糖复合物通常称为茶多糖, 是一类组成成分复杂且变化较大的混合物。' +
                    '对几种茶类的茶多糖含量测定的结果表明, 黑茶的茶多糖含量最高, 且其组分活性也比其它茶类要强, 这是因为在发酵茶中, 由于糖苷酶、蛋白酶、水解酶的作用, 而形成了相对长度较短的糖链和肽链的缘故, 短肽链较长肽链更易被吸收, 且生物活性更强, 这可能就是发酵茶尤其是黑茶茶多糖降血糖效果优于其它茶类的原因之一。'
            },
            {
                summary: '杀菌消炎',
                detail: '黑茶汤色的主要组成成分是茶黄素和茶红素。研究表明, 茶黄素不仅是一种有效的自由基清除剂和抗氧化剂, 还对肉毒芽杆菌、肠类杆菌、金黄色葡萄球菌、荚膜杆菌、蜡样芽孢杆菌有明显的抗菌作用。此外, 茶黄素对流感病毒的侵袭和轮状病毒和肠病毒的感染有一定的抑制作用。'
            },
            {
                summary: '利尿解毒',
